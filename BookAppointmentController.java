...
public class BookAppointmentController implements Initializable {
    ...
    @FXML
    private TableColumn<Admin, String> colDate;

    @FXML
    private TableColumn<Admin, Integer> colId;

    @FXML
    private TableColumn<Admin, String> colLocation;

    @FXML
    private TableColumn<Admin, String> colDescrip;

    @FXML
    private TableColumn<Admin, String> colTitle;
    
    @FXML
    private TableColumn<Admin, String> colStart;
    
    @FXML
    private TableColumn<Admin, String> colEnd;
    ...
    public void showBooks(){
        ObservableList<Admin> list = getAppointmentsList();
        
        colId.setCellValueFactory(new PropertyValueFactory<Admin, Integer>("id"));
        colDescrip.setCellValueFactory(new PropertyValueFactory<Admin, String>("description"));
        colLocation.setCellValueFactory(new PropertyValueFactory<Admin, String>("location"));
        colTitle.setCellValueFactory(new PropertyValueFactory<Admin, String>("title"));
        colDate.setCellValueFactory(new PropertyValueFactory<Admin, String>("date"));
        colStart.setCellValueFactory(new PropertyValueFactory<Admin, String>("starttime"));
        colEnd.setCellValueFactory(new PropertyValueFactory<Admin, String>("endtime"));
...
//If program runs into errors just delete everything from above
